...
export async function initApp() {
  try {
    ...
    populateElement("data-fullname-pic", data.fullname);
    populateElement("data-phone", data.phone);
    populateElement("data-email", data.email);
    populateElement("data-name1-study", data.person1); // Для секції "Про нас"
    populateElement("data-name2-hobby", data.person2); // Для секції "Про нас"
